...
let PluginConfig = class PluginConfig {
    constructor() {
        this.plugins = [];
    }
};
...
let NgChartjsService = class NgChartjsService {
    constructor(storeService, pluginConfig) {
        ...
        const plugins$1 = pluginConfig.plugins;
        if (plugins$1.length !== 0 || plugins$1) {
            for (let i = 0; i < plugins$1.length; i++) {
                if (plugins$1[i]) {
...
const NgChartjsCustomPluginToken = new InjectionToken('[ngx-chart-js] Global Default Plugin');
...
let NgChartjsModule = NgChartjsModule_1 = class NgChartjsModule {
    /**
     * Register a plugin.
     * @param plugin
     */
